on open location atomURL
	...
	-- s/\\\\%20/\\\\\\ /g        -- Unencode escaped spaces, e.g. 'user/Google%20Drive/project/file' => 'user/Google Drive/project/file'
	...
	set file_path to do shell script "echo '" & file_path & "' | sed 's/^[^&]*/'\"'\"'&'\"'\"'/' | sed s/\\\\%2F/\\\\//g | sed s/\\\\%20/\\\\\\ /g | sed s/\\&line=/:/ | sed s/\\&column=/:/"
